...
class Analyzer:
    ...
    # Metric methods
    ###########################################################################
    def losses_per_breath(self, target, clip=(0, None), loss_fn=None, breath_length=29):
    ...
    def default_metric(
        self, clip=(0, None), target=None, loss_fn=np.abs, breath_length=29
    ):
        ...
        return self.losses_per_breath(
            clip=clip, target=target, loss_fn=loss_fn, breath_length=breath_length
        ).mean()
    ...
    def plot(
        ...
        **kwargs
        ...
        if control:
            ...
            (u_in,) = twin_ax.plot(
                self.tt, np.clip(self.u_in, 0, 100), c="gray", label="control", **kwargs
            )
