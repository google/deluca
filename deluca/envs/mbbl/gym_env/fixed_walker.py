...
class FixedWalker(base_env_wrapper.base_env):
    ...
    def __init__(self, env_name='gym_fwalker2d', rand_seed=0, misc_info=None):
        super(FixedWalker, self).__init__(env_name, rand_seed, misc_info)
    ...
    def _set_reward_api(self):
        ...
        def reward(end_start, start_state, action):
            # the speed reward
        ...
        def reward_tf(end_start, start_state, action):
             # the speed reward
...
if __name__ == '__main__':
    ...
    #                  'gym_swimmer', 'gym_ant']
    test_env_name = ['gym_fwalker2d', 'gym_fhopper', 'gym_fant',
              'gym_fant2', 'gym_fant5', 'gym_fant10', 'gym_fant20', 'gym_fant30']
    for env_name in test_env_name:
        test_env = FixedWalker(env_name, 1234, None)
        api_env = FixedWalker(env_name, 1234, None)
        api_env.reset()
