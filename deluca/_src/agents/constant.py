...
ConstantState = base.EmptyAgentState
...
def constant(
  ...
  def control_fn(
      state: ConstantState, obs: base.EnvironmentState
  ) -> tuple[ConstantState, float | jnp.array]:
    del obs
    return state, control

  def update_fn(state: ConstantState) -> ConstantState:
    return state
