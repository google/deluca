...
from deluca.envs import Pendulum2D, MountainCar, Acrobot
import jax
...
def print_test_losses(axes, test_losses, name):
    ...
    for loss, loss_by_coord in test_losses:
        # loss_by_coord has shape (num_test_samples, obs_dim)
        # Take mean across test samples for each coordinate
